<?php include_once("header.php"); //Header ?>
	...
	<div class="container">
	<p>&nbsp;</p>
		<?php $paletteUrl = $_GET['palette'];//Palette TabelleNummer aus Url (muss immer obern sein) ?>
		
		<form method="post" action="add.php?palette=<?php echo $paletteUrl ?>" class="form-group">			
			...
			<label>Stück:</label><br><input type="text" name="cnt" required class="form-control"><br>
			<label>Packungen:</label><br><input type="text" name="pcs" required class="form-control"> <br><br>		
		...
		{			
			...
			echo "<p style='color:green;'>Model <b>$id</b> $paletteUrl TEST ist Hinzugefügt</p>";
		}		
  ...
  (function( $ ) {
    $.widget( "custom.combobox", {
      ...
      _removeIfInvalid: function( event, ui ) {
        ...
        this.input
          .val( "" )
          .attr( "title",  value + " - Model existiert nicht" )
          .tooltip( "open" );
        this.element.val( "" );
...
<button id="toggle">alle Modelle zeigen</button>	
-->
...
/* Interaction Cues  POPUP fuer Massage
----------------------------------*/
.ui-state-highlight,
